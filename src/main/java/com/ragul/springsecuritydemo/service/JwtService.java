...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails) {
        return generateToken(getPrincipalInfo(userDetails.getAuthorities()), userDetails);
    }
    ...
    public Map<String,Object> getPrincipalInfo(Collection<? extends GrantedAuthority> principal) {
